...
contains
!**************************************************************************************************
subroutine init_flap_controller_cyclic(array1,array2) bind(c,name='init_flap_controller_cyclic')
! Initialize Cyclic Flap Controller
implicit none
      !DEC$ IF .NOT. DEFINED(__LINUX__)
      !DEC$ ATTRIBUTES DLLEXPORT :: init_flap_controller_cyclic
      !GCC$ ATTRIBUTES DLLEXPORT :: init_flap_controller_cyclic
      !DEC$ END IF
